...
function Nav() {
  return (
    <nav className="flex justify-between items-center p-[1vw] text-[#d9d9d9]">
      <Link href={"#Home"} className="text-[1.66rem] font-bold">
        Bacgram
      </Link>
      <div className="text-[1.6rem] flex items-center justify-center gap-[3vw]">
...
function Home() {
  ...
  return (
    ...
    >
      ...
      <p className="text-center w-[47vw] text-[1.6rem]">
      ...
      <button
        className="flex items-center justify-between border-[#4F2DFA] border px-[4vw] py-[1vh] rounded-3xl bg-[#4F2DFA] gap-[.5vw] font-bold text-[1.6rem] hover:bg-transparent transition-colors duration-300 ease-in-out"
        onClick={() => {
          router.push("/login");
        }}
      >
        <svg
          ...
          viewBox="0 0 512 512"
          className="fill-[#d9d9d9] flex w-[2vw]"
        >
...
function About() {
  return (
    ...
    >
      ...
      <p className="text-[1.6rem] text-center w-[47vw]">
        <span className="important">Bacgram</span> is a social platform designed
        exclusively for students at BAC, It allows users to{" "}
        ...
        conversations, or just keeping in touch, Bacgram helps bring our student
